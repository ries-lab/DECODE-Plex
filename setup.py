...
setup(
    name="decode",
    version="1.0.0dev0",  # do not modify by hand set and sync with bumpversion
    packages=setuptools.find_packages(),
    include_package_data=True,
    install_requires=requirements,
    entry_points={
        "console_scripts": [
            "decode.info = cli.info:main",
            "decode.train = cli.train:main",
            "decode.infer = cli.infer:main",
            "decode.notebooks = cli.loading:main",
            "decode.hash = cli.hash:main",
        ],
    },
    zip_safe=False,
